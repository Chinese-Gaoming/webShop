...
function deleteGoods(i) {
	...
	//alert(zzzz);
  // alert(zzzz[i].type);
   var cc=zzzz[i].goodsNumber;
   //var ccc=encodeURI(encodeURI(cc))
   
	$.ajax({
		url : "deleteGoods?goodNumber="+cc+"",
		type : "get",
		dataType : "json",
		success : function(data) {//回调函数
			alert("删除成功");
					...
					<table class="table table-striped">
						...
						<thead style="display: block; height: 30px">
							<tr>
								...
								<td style="width:200px" class="success">商品类别</td>
								<td style="width:200px" class="success">上架时间</td>
								<td style="width:200px" class="success">商品价格</td>
